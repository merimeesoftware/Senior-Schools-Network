...
- **`components/media/OptimizedImage.tsx`** - Single image component with Next.js optimization
- **`components/media/ImageGallery.tsx`** - Multi-image grid component with filtering
...
- **`components/media/OptimizedImage.tsx`** - Component source
- **`components/media/ImageGallery.tsx`** - Gallery component source
