# Senior Schools Network — North Star

## Overview

This repository serves as the foundational hub for the Senior Schools Network project, inspired by the educational philosophy of Dr. John Senior as articulated in _The Restoration of Innocence: An Idea of a School_ ,the _Integrated Humanities lecture_ and related works. The project's north star is the promotion and loose affiliation of schools that embody education through sense, story & liturgy: poetic knowledge, natural exploration & sense based learning, liturgical rhythm, and narrative immersion, integrated with spiritual and moral formation rooted in Catholic and Western tradition. Drawing from Senior's emphasis on the "poetic mode" of apprehension—where knowledge begins with wonder, senses, and imagination, and rejects rigid schemas in favor of organic, experiential growth through good educators—this initiative focuses on identifying and highlighting existing schools that align with these principles, while encouraging new initiatives without imposition.

The objectives are:

1. **School Network Promotion**: Discover and promote schools already operating in this spirit (e.g., from an existing list of programs, high schools and colleges), fostering a loose network for mutual support and visibility.
2. **Encouragement for Participation**: Provide avenues for schools to apply for affiliation, individuals to reach out, or aspiring founders to start aligned schools  by connecting them with others alreaedy engaged in such work. Additial informal guidance is offered from the network—emphasizing flexibility and the role of dedicated educators over standardized curricula.
3. **Digital Platform**: Develop a website to showcase Senior's ideas, share resources (e.g., book lists, excerpts, media), and connect educators, parents, and stakeholders.
...
The guiding light is Senior's framework from the _Integrated Humanities lecture_ and _The Restoration of Innocence_, synthesized with complementary texts such as excerpts from Hugh of St. Victor's _Didascalicon_, G.K. Chesterton's _The Outline of Sanity_, Tolkien's _Mythopoeia_, Boethius's _The Consolation of Philosophy_, papal encyclicals like _Rerum Novarum_, and Aquinas's _Summa Theologica_ (e.g., on intellectual knowledge). This collection of works is to show that these are timeless educational ideas and wisdom and that this philosophy is inherently Catholic, exclusionary in its fidelity to core tenets, and resistant to modern systematization.
...
## User-Centric Design (StoryBrand Framework)

The platform follows the StoryBrand methodology. Visitors (parents, educators, aspiring founders) are positioned as the "hero" seeking restoration of innocence in education, facing problems like cultural decay and loss of wonder. Senior's philosophy and the network serve as the empathetic "guide," providing a clear plan for exploration, affiliation, and inspiration.
...
_Waypoint_: "Come unto me, all ye that labour and are heavy laden, and I will give you rest." (Matthew 11:28)
